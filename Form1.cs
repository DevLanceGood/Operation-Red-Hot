...
namespace SpaceInvaders
{
    ...
    public class Form1 : System.Windows.Forms.Form
    {
        ...
        //Array order is, {bullet speed, player speed, bomb firerate, alien color}
        string[] speeds;

        public Form1(string[] array)
        {
            //
        ...
        private void timer1_Tick(object sender, System.EventArgs e)
        {
            ...
            Console.WriteLine("Pause Statis: " + _pause);
        }
